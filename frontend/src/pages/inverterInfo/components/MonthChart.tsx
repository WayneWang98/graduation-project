...
class MonthChart extends Component<PropsType> {
    ...
    return (
      <div>
        <div className={styles['datePicker-container']}>
          ...
          <DatePicker allowClear={false} onChange={this.onChange} inputReadOnly={true} className={styles['datePicker']} picker="month" value={moment(date)}/>
        </div>
      </div>
    )
  }
